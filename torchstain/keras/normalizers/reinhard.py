...
from torchstain.keras.utils.lab2rgb import lab2rgb
from torchstain.keras.utils.split import csplit, cmerge, lab_split, lab_merge
from torchstain.keras.utils.stats import get_mean_std, standardize
...
"""
class KerasReinhardNormalizer(HENormalizer):
    ...
    def fit(self, target):
        # normalize
        target = keras.ops.cast(target, dtype="float32") / 255
    ...
    def normalize(self, I):
        # normalize
        I = keras.ops.cast(I, dtype="float32") / 255
        ...
        return keras.ops.cast((lab * 255), dtype="uint8")
